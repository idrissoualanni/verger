...
import * as schema from "@verger/shared/src/schema.js";

/**
 * Config Better Auth utilisée par le CLI (`better-auth generate` / `migrate`)
 * et les scripts locaux. Le runtime Workers utilise la factory
 * `createAuth(env)` de `src/lib/auth.ts`.
 */
